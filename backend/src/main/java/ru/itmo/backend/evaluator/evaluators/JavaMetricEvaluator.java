...
public class JavaMetricEvaluator implements MetricEvaluator {
    ...
    ClassMethod parseMethodName(String methodName, Map<String, String> metrics) throws MetricEvaluationException {
        ...
        String simpleClassName = packageName + "." + methodName.substring(0, simpleMethodName.length());
